...
gym.register(
    ...
    kwargs={
        ...
        "rsl_rl_alg_branch_cfg_entry_point": f"{agents.__name__}.rsl_rl_alg_branch_ppo_cfg:CartpolePPORunnerCfg",
        # "rsl_rl_alg_branch_cfg_entry_point": f"{agents.__name__}.rsl_rl_alg_branch_sac_cfg:CartpoleSACRunnerCfg",
